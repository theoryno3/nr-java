...
public class Amoeba {
    ...
    public <T extends Func_DoubVec_To_Doub> double[] minimize(final double[] point, final double[] dels, final T func) throws NRException {
    ...
    public <T extends Func_DoubVec_To_Doub> double[] minimize(final double[][] pp, final T func) throws NRException {
    ...
    public <T extends Func_DoubVec_To_Doub> double amotry(final double[][] p, final double[] y, final double[] psum,
	                            final int ihi, final double fac, final T func) throws NRException {
		...
		double ytry=func.eval(ptry); // Evaluate the function at the trial point.
