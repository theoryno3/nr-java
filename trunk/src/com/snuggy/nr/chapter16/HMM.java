...
public class HMM {
    ...
    private double[][] a; // Transition matrix and symbol probability matrix.
    private $double2d b; 
    private int[] obs; // Observed data.
    private int fbdone;
    private int mstat, nobs, ksym; // Number of states, observations, and
                                   // symbols.
    private int lrnrm;
    private double[][] alpha, beta, pstate; // Matrices ?, ?, and Pi .t/.
    private int[] arnrm, brnrm;
    ...
    public void baumwelch() throws NRException {
        ...
        double[][] bnew = doub_mat(mstat, ksym);
        int[] powtab = int_arr(10); // Fill table of powers of BIGI.
        for (i = 0; i < 10; i++)
