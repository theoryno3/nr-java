...
public class Svm {
    ...
    private double[] alph; // Vectors of ?’s before and after a step.
    private $double1d alphold; // Vectors of ?’s before and after a step.
    ...
    public double relax(final double lambda, final double om) throws NRException {
        ...
        double[] pinsum = doub_arr(m); // Stored sums over noninterior
                                        // variables.
